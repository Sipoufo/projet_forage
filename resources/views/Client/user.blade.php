                  ...
                  <div>
                      ...
                      <div class="tab-content">
                          ...
                          <div role="tabpanel" class="tab-pane fade" id="update_form">
                              <br>
                              <form method="post" action="/user/update" class="col-lg-8 offset-lg-2" enctype="multipart/form-data">
                                  @csrf
                                  @method('PUT')
                      ...
                      <div role="tabpanel" class="tab-pane fade" id="password_form">
                        <br>
                          ...
                          <form method="post" action="/user/change_password" class="col-lg-8 offset-lg-2" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
