...
<head>
    ...
    <title>Forage - Forgot Password</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">We get it, stuff happens. Just enter your phone number below
                                    ...
                                    <form action="/reset" method="post" class="user">
                                        ...
                                        <input type="submit" name="submit" value="Reset Password" class="btn btn-primary btn-user btn-solid btn-block"/>
                                    </form>
                                    <hr>
                                    <div class="text-center">
